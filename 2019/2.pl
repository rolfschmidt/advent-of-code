...
for my $Number1 (0 .. $CodeIndex) {
    ...
    for my $Number2 (0 .. $CodeIndex) {
        ...
        is($Number1, 56, 'Number 1 - Find the input noun and verb that cause the program to produce the output 19690720.');
        is($Number2, 96, 'Number 2 - Find the input noun and verb that cause the program to produce the output 19690720.');
